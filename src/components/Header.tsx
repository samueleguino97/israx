      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href="/teoria">Teoria</MobileNavItem>
            <MobileNavItem href="/normativo">Marco Normativo</MobileNavItem>

            <MobileNavItem href="/entrevistas">Entrevistas</MobileNavItem>

            <MobileNavItem href="/documentos-referencias">
              Documentos y Referencias
            </MobileNavItem>

            <MobileNavItem href="/juego">Juego Interactivo</MobileNavItem>
            <MobileNavItem href="/nosotros">Nosotros</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/teoria">Teoria</NavItem>
        <NavItem href="/normativo">Marco Normativo</NavItem>

        <NavItem href="/entrevistas">Entrevistas</NavItem>

        <NavItem href="/documentos-referencias">
          Documentos y Referencias
        </NavItem>

        <NavItem href="/juego">Juego Interactivo</NavItem>
    ...
    <>
      <div className="mx-auto mt-6 px-6 text-center">
        <h1 className="text-xl font-bold tracking-tight text-zinc-800 sm:text-2xl dark:text-zinc-100">
          <span className="text-orange-400"> EL NOMBRE</span> a nivel jurídico
          en Bolivia
        </h1>
      </div>
      <header
        ...
        >
          ...
          >
            <div className="relative flex gap-4">
              ...
              <div className="w-max justify-end md:justify-center">
